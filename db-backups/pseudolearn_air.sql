...
--
-- Host: mysql
-- Generation Time: May 23, 2026 at 03:45 PM
...
--
-- Database: `pseudolearn_air`
--

-- --------------------------------------------------------

--
-- Table structure for table `ars_result`
--

CREATE TABLE `ars_result` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ars_batch` int NOT NULL DEFAULT '1',
  ...
  `pseudo_langkah` int DEFAULT NULL,
  `pseudo_durasi` int DEFAULT NULL,
  `pseudo_label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pseudo_score` int DEFAULT NULL,
  `konversi_langkah` int DEFAULT NULL,
  `konversi_durasi` int DEFAULT NULL,
  `konversi_label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `konversi_score` int DEFAULT NULL,
...
('0199651d-b77a-7329-8b9a-0e5b6b2f16d6', '01995dec-678e-70cf-854a-b25e2c2d0d28', '01995df6-35ed-7363-9d42-578622c3e4f2', 0, '[\"double pajak = 0.1;\", \"int harga_motor = 25000000;\", \"int uang_bayar;\", \"float pajak_jual;\", \"pajak_jual = pajak * harga_motor;\", \"uang_bayar = harga_motor + pajak_jual;\", \"System.out.print(uang_bayar);\"]', '27500000', 'easy', '2025-09-19 20:14:30', '2026-05-23 04:04:34', '2026-05-23 04:04:34'),
...
('1e77c177-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e4c89-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static String[] q = new String[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(String d) { q[r++] = d; s++; }\r\n    public static void main(String[] args) {\r\n        enqueue(\"Rina\");\r\n        enqueue(\"Doni\");\r\n        enqueue(\"Yudi\");\r\n        System.out.println(q[f]);\r\n        System.out.println(s);\r\n    }\r\n}', 'Rina\r\n3', 'easy', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e77e3f3-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e64af-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static int[] q = new int[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(int d) { q[r++] = d; s++; }\r\n    public static void main(String[] args) {\r\n        enqueue(101);\r\n        enqueue(102);\r\n        enqueue(103);\r\n        System.out.println(\"FRONT : \" + q[f]);\r\n        System.out.println(\"REAR  : \" + q[r - 1]);\r\n        System.out.println(\"SIZE  : \" + s);\r\n    }\r\n}', 'FRONT : 101\r\nREAR  : 103\r\nSIZE  : 3', 'easy', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e77f187-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e6ad9-543f-11f1-a937-e4a8dfe60766', 0, 'import java.util.Scanner;\r\npublic class Main {\r\n    static String[] q = new String[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(String d) { q[r++] = d; s++; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = f; i < r; i++) { t += q[i]; if (i < r - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        Scanner sc = new Scanner(System.in);\r\n        for (int i = 0; i < 3; i++) {\r\n            enqueue(sc.nextLine());\r\n            System.out.println(\"Antrian: \" + isi() + \" Ukuran: \" + s);\r\n        }\r\n        sc.close();\r\n    }\r\n}', 'Antrian: [Siti] Ukuran: 1\r\nAntrian: [Siti, Bagas] Ukuran: 2\r\nAntrian: [Siti, Bagas, Citra] Ukuran: 3', 'easy', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e7800d2-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e6f93-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static int[] q = new int[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(int d) { q[r++] = d; s++; }\r\n    static boolean isEmpty() { return s == 0; }\r\n    public static void main(String[] args) {\r\n        System.out.println(isEmpty());\r\n        enqueue(201);\r\n        enqueue(202);\r\n        System.out.println(isEmpty());\r\n        System.out.println(s);\r\n        System.out.println(q[f]);\r\n    }\r\n}', 'true\r\nfalse\r\n2\r\n201', 'easy', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e780c1b-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e755d-543f-11f1-a937-e4a8dfe60766', 0, 'import java.util.Scanner;\r\npublic class Main {\r\n    static int[] q = new int[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(int d) { q[r++] = d; s++; }\r\n    public static void main(String[] args) {\r\n        Scanner sc = new Scanner(System.in);\r\n        for (int i = 0; i < 3; i++) enqueue(sc.nextInt());\r\n        System.out.println(\"FRONT  : \" + q[f]);\r\n        System.out.println(\"REAR   : \" + q[r - 1]);\r\n        System.out.println(\"SIZE   : \" + s);\r\n        System.out.println(\"ISEMPTY: \" + (s == 0));\r\n        sc.close();\r\n    }\r\n}', 'FRONT  : 7\r\nREAR   : 9\r\nSIZE   : 3\r\nISEMPTY: false', 'easy', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e7817b3-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e7b61-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static String[] q = new String[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(String d) { q[r++] = d; s++; }\r\n    static String dequeue() { s--; return q[f++]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = f; i < r; i++) { t += q[i]; if (i < r - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        enqueue(\"Hendra\"); enqueue(\"Lestari\"); enqueue(\"Miko\");\r\n        String dipanggil = dequeue();\r\n        System.out.println(\"Dipanggil  : \" + dipanggil);\r\n        System.out.println(\"Sisa       : \" + isi());\r\n        System.out.println(\"FRONT baru : \" + q[f]);\r\n        System.out.println(\"SIZE baru  : \" + s);\r\n    }\r\n}', 'Dipanggil  : Hendra\r\nSisa       : [Lestari, Miko]\r\nFRONT baru : Lestari\r\nSIZE baru  : 2', 'medium', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e781ff0-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e8163-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static int[] q = new int[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(int d) { q[r++] = d; s++; }\r\n    static int dequeue() { s--; return q[f++]; }\r\n    static boolean isEmpty() { return s == 0; }\r\n    public static void main(String[] args) {\r\n        for (int i = 1; i <= 5; i++) enqueue(i);\r\n        while (!isEmpty()) {\r\n            int pembeli = dequeue();\r\n            System.out.println(\"Dilayani: \" + pembeli + \" Sisa: \" + s);\r\n        }\r\n        System.out.println(\"Antrian telah kosong\");\r\n    }\r\n}', 'Dilayani: 1 Sisa: 4\r\nDilayani: 2 Sisa: 3\r\nDilayani: 3 Sisa: 2\r\nDilayani: 4 Sisa: 1\r\nDilayani: 5 Sisa: 0\r\nAntrian telah kosong', 'medium', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e782799-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e881b-543f-11f1-a937-e4a8dfe60766', 0, 'import java.util.Scanner;\r\npublic class Main {\r\n    static String[] q = new String[10];\r\n    static int f = 0, r = 0, s = 0;\r\n    static void enqueue(String d) { q[r++] = d; s++; }\r\n    static String dequeue() { s--; return q[f++]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = f; i < r; i++) { t += q[i]; if (i < r - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        Scanner sc = new Scanner(System.in);\r\n        enqueue(sc.nextLine()); enqueue(sc.nextLine());\r\n        String a = dequeue();\r\n        enqueue(sc.nextLine());\r\n        String b = dequeue();\r\n        enqueue(sc.nextLine());\r\n        System.out.println(\"a         : \" + a);\r\n        System.out.println(\"b         : \" + b);\r\n        System.out.println(\"Isi akhir : \" + isi());\r\n        System.out.println(\"SIZE      : \" + s);\r\n        sc.close();\r\n    }\r\n}', 'a         : A\r\nb         : B\r\nIsi akhir : [C, D]\r\nSIZE      : 2', 'medium', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e7830db-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e8f05-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static int[] q = new int[20]; static int f = 0, r = 0, s = 0;\r\n    static int[] st = new int[20]; static int top = -1;\r\n    static void enqueue(int d) { q[r++] = d; s++; }\r\n    static int dequeue() { s--; return q[f++]; }\r\n    static void push(int d) { st[++top] = d; }\r\n    static int pop() { return st[top--]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = f; i < r; i++) { t += q[i]; if (i < r - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        for (int i = 1; i <= 5; i++) enqueue(i);\r\n        System.out.println(\"Sebelum: \" + isi());\r\n        while (s > 0) push(dequeue());\r\n        while (top >= 0) enqueue(pop());\r\n        System.out.println(\"Sesudah: \" + isi());\r\n    }\r\n}', 'Sebelum: [1, 2, 3, 4, 5]\r\nSesudah: [5, 4, 3, 2, 1]', 'medium', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e783f7b-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e9341-543f-11f1-a937-e4a8dfe60766', 0, 'import java.util.Scanner;\r\npublic class Main {\r\n    static char[] q = new char[20]; static int f = 0, r = 0, s = 0;\r\n    static char[] st = new char[20]; static int top = -1;\r\n    static void enqueue(char d) { q[r++] = d; s++; }\r\n    static char dequeue() { s--; return q[f++]; }\r\n    static void push(char d) { st[++top] = d; }\r\n    static char pop() { return st[top--]; }\r\n    public static void main(String[] args) {\r\n        Scanner sc = new Scanner(System.in);\r\n        String kata = sc.nextLine();\r\n        for (char c : kata.toCharArray()) { enqueue(c); push(c); }\r\n        boolean isPalindrom = true;\r\n        while (s > 0) if (dequeue() != pop()) isPalindrom = false;\r\n        System.out.println(\"Palindrom: \" + isPalindrom);\r\n        sc.close();\r\n    }\r\n}', 'Palindrom: true', 'medium', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e784881-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e96e7-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static int[] q = new int[20]; static int qf = 0, qr = 0, qs = 0;\r\n    static int[] tmp = new int[20]; static int tf = 0, tr = 0, ts = 0;\r\n    static void enqQ(int d) { q[qr++] = d; qs++; }\r\n    static int deqQ() { qs--; return q[qf++]; }\r\n    static void enqT(int d) { tmp[tr++] = d; ts++; }\r\n    static int deqT() { ts--; return tmp[tf++]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = qf; i < qr; i++) { t += q[i]; if (i < qr - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        for (int d : new int[]{11, 22, 33, 44, 55}) enqQ(d);\r\n        int cari = 33; boolean ditemukan = false;\r\n        while (qs > 0) { int e = deqQ(); if (e == cari) ditemukan = true; enqT(e); }\r\n        while (ts > 0) enqQ(deqT());\r\n        System.out.println(\"Ditemukan: \" + ditemukan);\r\n        System.out.println(\"Antrian  : \" + isi());\r\n    }\r\n}', 'Ditemukan: true\r\nAntrian  : [11, 22, 33, 44, 55]', 'hard', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e78530a-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78e99e1-543f-11f1-a937-e4a8dfe60766', 0, 'import java.util.Scanner;\r\npublic class Main {\r\n    static int[] q = new int[20]; static int qf = 0, qr = 0, qs = 0;\r\n    static int[] tmp = new int[20]; static int tf = 0, tr = 0, ts = 0;\r\n    static void enqQ(int d) { q[qr++] = d; qs++; }\r\n    static int deqQ() { qs--; return q[qf++]; }\r\n    static void enqT(int d) { tmp[tr++] = d; ts++; }\r\n    static int deqT() { ts--; return tmp[tf++]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = qf; i < qr; i++) { t += q[i]; if (i < qr - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        Scanner sc = new Scanner(System.in);\r\n        for (int i = 0; i < 5; i++) enqQ(sc.nextInt());\r\n        int minimum = q[qf];\r\n        while (qs > 0) { int e = deqQ(); if (e < minimum) minimum = e; enqT(e); }\r\n        while (ts > 0) enqQ(deqT());\r\n        System.out.println(\"Minimum: \" + minimum);\r\n        System.out.println(\"Antrian: \" + isi());\r\n        sc.close();\r\n    }\r\n}', 'Minimum: 10\r\nAntrian: [50, 20, 80, 10, 60]', 'hard', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e785bd3-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78ea070-543f-11f1-a937-e4a8dfe60766', 0, 'import java.util.Scanner;\r\npublic class Main {\r\n    static int[] q = new int[20]; static int qf = 0, qr = 0, qs = 0;\r\n    static int[] tmp = new int[20]; static int tf = 0, tr = 0, ts = 0;\r\n    static void enqQ(int d) { q[qr++] = d; qs++; }\r\n    static int deqQ() { qs--; return q[qf++]; }\r\n    static void enqT(int d) { tmp[tr++] = d; ts++; }\r\n    static int deqT() { ts--; return tmp[tf++]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = qf; i < qr; i++) { t += q[i]; if (i < qr - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        Scanner sc = new Scanner(System.in);\r\n        int cari = sc.nextInt();\r\n        for (int d : new int[]{2, 5, 2, 3, 2, 5, 4}) enqQ(d);\r\n        int frekuensi = 0;\r\n        while (qs > 0) { int e = deqQ(); if (e == cari) frekuensi++; enqT(e); }\r\n        while (ts > 0) enqQ(deqT());\r\n        System.out.println(\"Frekuensi \" + cari + \" : \" + frekuensi);\r\n        System.out.println(\"Antrian     : \" + isi());\r\n        sc.close();\r\n    }\r\n}', 'Frekuensi 2 : 3\r\nAntrian     : [2, 5, 2, 3, 2, 5, 4]', 'hard', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e786311-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78ea58d-543f-11f1-a937-e4a8dfe60766', 0, 'public class Main {\r\n    static int[] q = new int[20]; static int f = 0, r = 0, s = 0;\r\n    static int[] st = new int[20]; static int top = -1;\r\n    static void enqueue(int d) { q[r++] = d; s++; }\r\n    static int dequeue() { s--; return q[f++]; }\r\n    static void push(int d) { st[++top] = d; }\r\n    static int pop() { return st[top--]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = f; i < r; i++) { t += q[i]; if (i < r - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        for (int d : new int[]{301, 302, 303, 304, 305}) enqueue(d);\r\n        int cari = 303; boolean ditemukan = false;\r\n        while (s > 0) { int e = dequeue(); if (e == cari) ditemukan = true; push(e); }\r\n        while (top >= 0) enqueue(pop());\r\n        System.out.println(\"Ditemukan: \" + ditemukan);\r\n        System.out.println(\"Antrian  : \" + isi());\r\n    }\r\n}', 'Ditemukan: true\r\nAntrian  : [305, 304, 303, 302, 301]', 'hard', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('1e786a43-5440-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'e78eaba7-543f-11f1-a937-e4a8dfe60766', 0, 'import java.util.Scanner;\r\npublic class Main {\r\n    static int[] q = new int[20]; static int f = 0, r = 0, s = 0;\r\n    static int[] st = new int[20]; static int top = -1;\r\n    static void enqueue(int d) { q[r++] = d; s++; }\r\n    static int dequeue() { s--; return q[f++]; }\r\n    static void push(int d) { st[++top] = d; }\r\n    static int pop() { return st[top--]; }\r\n    static String isi() {\r\n        String t = \"[\";\r\n        for (int i = f; i < r; i++) { t += q[i]; if (i < r - 1) t += \", \"; }\r\n        return t + \"]\";\r\n    }\r\n    public static void main(String[] args) {\r\n        Scanner sc = new Scanner(System.in);\r\n        for (int i = 0; i < 5; i++) enqueue(sc.nextInt());\r\n        int maksimum = q[f], posisi = 1, index = 1;\r\n        while (s > 0) { int e = dequeue(); if (e > maksimum) { maksimum = e; posisi = index; } push(e); index++; }\r\n        while (top >= 0) enqueue(pop());\r\n        System.out.println(\"Maksimum : \" + maksimum);\r\n        System.out.println(\"Posisi   : \" + posisi);\r\n        System.out.println(\"Antrian  : \" + isi());\r\n        sc.close();\r\n    }\r\n}', 'Maksimum : 95\r\nPosisi   : 4\r\nAntrian  : [80, 95, 60, 90, 75]', 'hard', '2026-05-20 11:36:19', '2026-05-20 11:36:19', NULL),
('eb798f75-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ec2df-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { int d; Node n; Node(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node head = new Node(10);\r\n        head.n = new Node(20);\r\n        head.n.n = new Node(30);\r\n        \r\n        System.out.println(\"Depan: \" + head.d);\r\n        System.out.println(\"Belakang: \" + head.n.n.d);\r\n    }\r\n}', 'Depan: 10\r\nBelakang: 30', 'easy', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb7998d6-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ecdd8-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { String d; Node n; Node(String d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(\"A\");\r\n        h.n = new Node(\"B\");\r\n        h.n.n = new Node(\"C\");\r\n        \r\n        int count = 0;\r\n        Node tmp = h;\r\n        while(tmp != null) {\r\n            count++;\r\n            tmp = tmp.n;\r\n        }\r\n        System.out.println(\"Jumlah: \" + count);\r\n    }\r\n}', 'Jumlah: 3', 'easy', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb799d4b-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ed2e4-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { String d; Node n; Node(String d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(\"B\");\r\n        h.n = new Node(\"C\");\r\n        \r\n        Node baru = new Node(\"A\");\r\n        baru.n = h;\r\n        h = baru;\r\n        \r\n        while(h != null) {\r\n            System.out.print(h.d + \" \");\r\n            h = h.n;\r\n        }\r\n    }\r\n}', 'A B C ', 'easy', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79a059-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ed4b1-5699-11f1-b849-e4a8dfe60766', 0, 'class DNode { String d; DNode p, n; DNode(String d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        DNode l1 = new DNode(\"Lagu1\");\r\n        DNode l2 = new DNode(\"Lagu2\");\r\n        \r\n        l1.n = l2;\r\n        l2.p = l1;\r\n        \r\n        System.out.println(\"Maju: \" + l1.d + \", \" + l1.n.d);\r\n        System.out.println(\"Mundur: \" + l2.d + \", \" + l2.p.d);\r\n    }\r\n}', 'Maju: Lagu1, Lagu2\r\nMundur: Lagu2, Lagu1', 'easy', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79a32a-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ed658-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { String d; Node n; Node(String d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(\"Sate\");\r\n        h.n = new Node(\"Soto\");\r\n        h.n.n = new Node(\"Bakso\");\r\n        \r\n        Node tmp = h;\r\n        while(tmp != null) {\r\n            System.out.println(tmp.d);\r\n            tmp = tmp.n;\r\n        }\r\n    }\r\n}', 'Sate\r\nSoto\r\nBakso', 'easy', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79a5dc-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ed7fd-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { int d; Node n; Node(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(101);\r\n        h.n = new Node(102);\r\n        h.n.n = new Node(103);\r\n        \r\n        int cari = 102;\r\n        boolean ada = false;\r\n        Node tmp = h;\r\n        while(tmp != null) {\r\n            if(tmp.d == cari) ada = true;\r\n            tmp = tmp.n;\r\n        }\r\n        System.out.println(\"Buku \" + cari + \" Ditemukan: \" + ada);\r\n    }\r\n}', 'Buku 102 Ditemukan: true', 'medium', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79a88d-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ed997-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { String d; Node n; Node(String d){this.d=d;} }\npublic class Main {\n    public static void main(String[] args) {\n        Node h = new Node(\"LaguA\");\n        h.n = new Node(\"LaguB\");\n        h.n.n = new Node(\"LaguC\");\n        \n        Node t = h;\n        while(t.n.n != null) {\n            t = t.n;\n        }\n        t.n = null;\n        \n        while(h != null) {\n            System.out.print(h.d + \" \");\n            h = h.n;\n        }\n    }\n}', 'LaguA LaguB ', 'medium', '2026-05-23 11:24:10', '2026-05-23 11:27:49', NULL),
('eb79ab8a-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94edb68-5699-11f1-b849-e4a8dfe60766', 0, 'class DNode { int d; DNode p, n; DNode(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        DNode n1=new DNode(10), n2=new DNode(20), n3=new DNode(30);\r\n        n1.n=n2; n2.p=n1; n2.n=n3; n3.p=n2;\r\n        \r\n        DNode t = n1;\r\n        while(t.n != null) t = t.n;\r\n        if(t.p != null) t.p.n = null;\r\n        \r\n        t = n1;\r\n        while(t != null) {\r\n            System.out.print(t.d + \" \");\r\n            t = t.n;\r\n        }\r\n    }\r\n}', '10 20 ', 'medium', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79afda-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94edd2e-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { String d; Node n; Node(String d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(\"Budi\");\r\n        h.n = new Node(\"Doni\");\r\n        \r\n        Node c = new Node(\"Caca\");\r\n        c.n = h.n;\r\n        h.n = c;\r\n        \r\n        while(h != null) {\r\n            System.out.print(h.d + \" \");\r\n            h = h.n;\r\n        }\r\n    }\r\n}', 'Budi Caca Doni ', 'medium', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79b327-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94edf35-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { int d; Node n; Node(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(5000);\r\n        h.n = new Node(10000);\r\n        h.n.n = new Node(15000);\r\n        \r\n        int total = 0;\r\n        Node tmp = h;\r\n        while(tmp != null) {\r\n            total += tmp.d;\r\n            tmp = tmp.n;\r\n        }\r\n        System.out.println(\"Total: \" + total);\r\n    }\r\n}', 'Total: 30000', 'medium', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79b5db-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ee0d4-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { int d; Node n; Node(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(80);\r\n        h.n = new Node(95);\r\n        h.n.n = new Node(75);\r\n        \r\n        int maksimum = h.d;\r\n        Node tmp = h.n;\r\n        while(tmp != null) {\r\n            if(tmp.d > maksimum) maksimum = tmp.d;\r\n            tmp = tmp.n;\r\n        }\r\n        System.out.println(\"Maksimum: \" + maksimum);\r\n    }\r\n}', 'Maksimum: 95', 'hard', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79b8a4-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ee249-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { int d; Node n; Node(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(1);\r\n        h.n = new Node(2);\r\n        h.n.n = new Node(3);\r\n        \r\n        Node prev = null, curr = h, next = null;\r\n        while(curr != null) {\r\n            next = curr.n;\r\n            curr.n = prev;\r\n            prev = curr;\r\n            curr = next;\r\n        }\r\n        h = prev;\r\n        \r\n        while(h != null) {\r\n            System.out.print(h.d + \" \");\r\n            h = h.n;\r\n        }\r\n    }\r\n}', '3 2 1 ', 'hard', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79bb7b-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ee45e-5699-11f1-b849-e4a8dfe60766', 0, 'class DNode { int d; DNode p, n; DNode(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        DNode n1 = new DNode(10), n3 = new DNode(30);\r\n        n1.n = n3; n3.p = n1;\r\n        \r\n        DNode n2 = new DNode(20);\r\n        n2.n = n1.n;\r\n        n2.p = n1;\r\n        n1.n.p = n2;\r\n        n1.n = n2;\r\n        \r\n        while(n1 != null) {\r\n            System.out.print(n1.d + \" \");\r\n            n1 = n1.n;\r\n        }\r\n    }\r\n}', '10 20 30 ', 'hard', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79be6a-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ee70d-5699-11f1-b849-e4a8dfe60766', 0, 'class Node { int d; Node n; Node(int d){this.d=d;} }\r\npublic class Main {\r\n    public static void main(String[] args) {\r\n        Node h = new Node(5);\r\n        h.n = new Node(10);\r\n        h.n.n = new Node(15);\r\n        \r\n        Node tmp = h, prev = null;\r\n        int hapus = 10;\r\n        \r\n        while(tmp != null && tmp.d != hapus) {\r\n            prev = tmp;\r\n            tmp = tmp.n;\r\n        }\r\n        if(tmp != null && prev != null) prev.n = tmp.n;\r\n        \r\n        while(h != null) {\r\n            System.out.print(h.d + \" \");\r\n            h = h.n;\r\n        }\r\n    }\r\n}', '5 15 ', 'hard', '2026-05-23 11:24:10', '2026-05-23 11:24:10', NULL),
('eb79c172-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'a94ee98d-5699-11f1-b849-e4a8dfe60766', 0, 'class DNode { String d; DNode p,n; DNode(String d){this.d=d;} }\npublic class Main {\n    public static void main(String[] args) {\n        DNode n1 = new DNode(\"Rock\");\n        DNode n2 = new DNode(\"Jazz\");\n        DNode n3 = new DNode(\"Pop\");\n        \n        n1.n = n2; n2.p = n1;\n        n2.n = n3; n3.p = n2;\n        \n        DNode tail = n3;\n        while(tail != null) {\n            System.out.print(tail.d + \" \");\n            tail = tail.p;\n        }\n    }\n}', 'Pop Jazz Rock ', 'hard', '2026-05-23 11:24:10', '2026-05-23 11:27:49', NULL);
...
--
-- Table structure for table `chatbot_access_logs`
--

CREATE TABLE `chatbot_access_logs` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_mahasiswa` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_level` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_soal` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` enum('biasa','adaptive') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'biasa',
...
--
-- Table structure for table `chatbot_adaptive_logs`
--

CREATE TABLE `chatbot_adaptive_logs` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_mahasiswa` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nim` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nama` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_kelas` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kelas` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_level` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `level_soal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_soal` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jenis_soal` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `jumlah_langkah` int UNSIGNED NOT NULL DEFAULT '0',
  `waktu_mulai` timestamp NULL DEFAULT NULL,
  `waktu_selesai` timestamp NULL DEFAULT NULL,
  `id_label_skor` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `labeling` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `durasi_menit` int UNSIGNED DEFAULT NULL,
  `total_akses_chatbot_adaptive` int UNSIGNED NOT NULL DEFAULT '0',
  `pesan_bimbingan` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `chatbot_logs` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_mahasiswa` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `access_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_level` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_soal` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` enum('biasa','adaptive') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'biasa',
  `pesan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `respons` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('01985f44-f662-72f9-a85b-a7b256942492', 'Stack', 'assets/media/level_image/level_688b13cbbc675.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 9, 0, '2025-07-30 23:56:51', '2026-05-23 04:30:48', NULL),
('019863c4-59f9-7319-9104-08267fc3c551', 'Queue', 'assets/media/level_image/level_68a69ecb76297.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 1, 1, '2025-07-31 20:54:29', '2026-04-08 22:04:44', NULL),
('01995dec-678e-70cf-854a-b25e2c2d0d28', 'Tipe Data', 'assets/media/level_image/level_696cfb93a5cd8.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 3, 1, '2025-09-18 10:43:18', '2026-05-23 04:30:44', NULL),
('01995e0c-9825-73b3-b94f-2ae0542eabef', 'Kondisi', 'assets/media/level_image/level_696cfbb088f61.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 4, 0, '2025-09-18 11:18:27', '2026-05-23 04:30:45', NULL),
('01995e0d-85fe-7041-8c7e-cdfbc81bf1ed', 'Perulangan', 'assets/media/level_image/level_696cfbc71833b.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 5, 0, '2025-09-18 11:19:28', '2026-05-23 04:30:46', NULL),
('01995e12-4580-7361-b0d1-379bdea0b2b6', 'Fungsi', 'assets/media/level_image/level_696cfbdbcdcfe.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 6, 0, '2025-09-18 11:24:39', '2026-05-23 04:30:46', NULL),
('01995e13-29af-7010-8995-1a40e4504851', 'Array 1', 'assets/media/level_image/level_696cfbebd15c6.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 7, 0, '2025-09-18 11:25:38', '2026-05-23 04:30:47', NULL),
('01995e17-eb90-721f-92c5-3ce5162cedfd', 'Sorting', 'assets/media/level_image/level_696cfc29a2fea.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 10, 0, '2025-09-18 11:30:50', '2026-05-23 04:30:48', NULL),
('01995e18-9100-7037-9f92-b6491990b048', 'Searching', 'assets/media/level_image/level_696cfd336aeb4.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 11, 0, '2025-09-18 11:31:32', '2026-05-23 04:30:51', NULL),
('01996adc-c3ca-712b-abc0-933c691ccfc8', 'Array 2', 'assets/media/level_image/level_696cfc0852e19.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long', 'Cek kembali kesalahan pada urutan algoritma', 8, 0, '2025-09-21 06:01:17', '2026-05-23 04:30:47', NULL),
('019e548c-436c-7287-a08d-3d6248338075', 'Linked List', 'assets/media/level_image/level_6a118c5a257f3.png', 'Cek kembali kesalahan pada tipe data int, String, Double, Float, long.', 'Cek kembali kesalahan pada urutan algoritma.', 2, 1, '2026-05-23 04:15:39', '2026-05-23 04:30:41', NULL);
...
('a94ec2df-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menyambung Tiga Gerbong Kereta', '<p>Sebuah kereta barang dirangkai menggunakan konsep Single Linked List. Gerbong pertama (head) memiliki beban 10 ton. Kemudian disambungkan gerbong kedua dengan 20 ton, dan gerbong ketiga 30 ton.</p><p>Buat simpul untuk ketiga gerbong tersebut lalu cetak beban pada gerbong pertama dan gerbong terakhir secara berurutan.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat node head dengan nilai 10\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Sambungkan head.next dengan node baru bernilai 20\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Sambungkan head.next.next dengan node baru bernilai 30\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT nilai dari head (Depan)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT nilai dari head.next.next (Belakang)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 1, 1, 'easy', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ecdd8-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menghitung Total Gerbong Kereta', '<p>Rangkaian gerbong kereta (SLL) berisi daftar kode barang: \"A\", \"B\", dan \"C\". Petugas ingin menghitung berapa total gerbong yang ada dalam rangkaian tersebut menggunakan perulangan.</p><p>Tentukan total jumlah gerbong dengan menelusuri Linked List dari depan hingga akhir.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"count\", \"tipe_data\": \"int\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat node A, B, C dan sambungkan menjadi A -> B -> C\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set count = 0, Node sementara = head\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA sementara tidak kosong:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  tambah count dengan 1\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  pindahkan sementara ke node selanjutnya (sementara = sementara.next)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT jumlah gerbong\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 2, 1, 'easy', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ed2e4-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menambah Gerbong di Paling Depan', '<p>Sebuah rangkaian gerbong SLL saat ini memiliki isi \"B\" lalu \"C\". Kepala stasiun memerintahkan untuk menyisipkan gerbong baru berisi \"A\" tepat di posisi paling depan (menjadi head baru).</p><p>Sisipkan gerbong \"A\" di depan \"B\", kemudian cetak seluruh isi rangkaian dari depan ke belakang.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"baru\", \"tipe_data\": \"Node\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL awal: head = B, head.next = C\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat node baru = A\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Sambungkan node baru ke head awal (baru.next = head)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Ubah head menjadi node baru (head = baru)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Telusuri dan PRINT semua isi SLL\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 3, 1, 'easy', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ed4b1-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Navigasi Playlist Lagu Maju dan Mundur', '<p>Sebuah aplikasi musik menggunakan Double Linked List (DLL) untuk menyimpan playlist. Terdapat dua lagu: \"Lagu1\" dan \"Lagu2\". Lagu dapat diputar ke lagu selanjutnya (next) atau kembali ke lagu sebelumnya (prev).</p><p>Buatlah DLL untuk kedua lagu tersebut, lalu cetak urutan maju dan urutan mundur dengan memanfaatkan pointer next dan prev.</p>', '[{\"konversi\": 0, \"variabel\": \"lagu1\", \"tipe_data\": \"DNode\"}, {\"konversi\": 0, \"variabel\": \"lagu2\", \"tipe_data\": \"DNode\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat DNode l1 (Lagu1) dan l2 (Lagu2)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"l1.next = l2\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"l2.prev = l1\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT Maju: l1 lalu l1.next\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT Mundur: l2 lalu l2.prev\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 4, 1, 'easy', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ed658-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menampilkan Seluruh Daftar Pesanan Makanan', '<p>Sebuah restoran mencatat pesanan Sate, Soto, dan Bakso ke dalam Single Linked List secara berurutan. Pelayan ingin melihat semua daftar pesanan yang masuk dari pesanan pertama hingga terakhir.</p><p>Lakukan traversal (penelusuran) pada LinkedList dan cetak setiap pesanan ke layar.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"tmp\", \"tipe_data\": \"Node\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL: Sate -> Soto -> Bakso\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set node sementara = head\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA sementara tidak kosong:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  PRINT data pada node sementara\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  sementara = sementara.next\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 5, 1, 'easy', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ed7fd-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Mencari Buku di Rak Perpustakaan', '<p>Rak buku perpustakaan menyimpan ID buku dalam Single Linked List dengan urutan: 101, 102, dan 103. Pustakawan ingin mengecek apakah ID buku <strong>102</strong> tersedia di rak tersebut.</p><p>Telusuri SLL dari awal. Jika ditemukan, ubah status menjadi TRUE, lalu cetak hasil penemuannya.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"ada\", \"tipe_data\": \"boolean\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL dengan urutan 101 -> 102 -> 103\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Tentukan target yang dicari = 102\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set boolean ada = false, sementara = head\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN penelusuran sampai node habis:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  JIKA nilai node == target MAKA ada = true\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  pindah ke node berikutnya\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT status ditemukan (ada)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 6, 1, 'medium', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ed997-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menghapus Lagu Terakhir dari Playlist', '<p>Sebuah playlist lagu disimpan dalam Single Linked List dengan urutan LaguA -> LaguB -> LaguC. Karena LaguC sudah tidak populer, admin ingin menghapus lagu terakhir dari playlist tersebut.</p><p>Telusuri node hingga sebelum node terakhir, putus sambungannya, lalu cetak isi playlist yang tersisa.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"temp\", \"tipe_data\": \"Node\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL: LaguA -> LaguB -> LaguC\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set node temp = head\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA temp.next.next tidak kosong:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  temp = temp.next\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Putus node terakhir (temp.next = null)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Telusuri dan PRINT playlist tersisa\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 7, 1, 'medium', '2026-05-23 11:22:19', '2026-05-23 11:27:49', NULL),
('a94edb68-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Melepas Gerbong Terakhir Kereta', '<p>Rangkaian Double Linked List menyimpan nilai gerbong 10 <-> 20 <-> 30. Karena beban terlalu berat, petugas mekanik memotong dan melepas gerbong paling belakang (tail = 30).</p><p>Temukan gerbong terakhir, putus sambungannya, lalu cetak isi dari depan ke belakang.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"DNode\"}, {\"konversi\": 0, \"variabel\": \"temp\", \"tipe_data\": \"DNode\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat DLL: 10 <-> 20 <-> 30\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Telusuri sampai menemukan node terakhir (temp.next == null)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Putus sambungan dari node sebelum terakhir (temp.prev.next = null)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Telusuri dari head untuk PRINT sisa gerbong\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 8, 1, 'medium', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94edd2e-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menyisipkan Peserta di Tengah Barisan', '<p>Barisan Single Linked List awalnya berisi \"Budi\" yang menyambung ke \"Doni\". Tiba-tiba \"Caca\" datang dan petugas menyisipkan Caca tepat di antara Budi dan Doni.</p><p>Lakukan proses <em>Insert After</em> pada node Budi, lalu cetak urutan barisan yang baru.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"caca\", \"tipe_data\": \"Node\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL: head(Budi) -> node(Doni)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat node baru Caca\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Sambungkan next dari Caca ke Doni (caca.next = head.next)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Sambungkan next dari Budi ke Caca (head.next = caca)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Telusuri dan PRINT seluruh barisan baru\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 9, 1, 'medium', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94edf35-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menghitung Total Belanjaan di Kasir', '<p>Kasir menyimpan riwayat harga belanja pelanggan di Single Linked List dengan data: 5000, 10000, dan 15000. Kasir ingin menghitung jumlah keseluruhan belanjaan secara otomatis.</p><p>Telusuri elemen dari depan, jumlahkan nilainya ke dalam satu variabel, lalu cetak totalnya.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"total\", \"tipe_data\": \"int\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL berisi: 5000 -> 10000 -> 15000\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set total = 0, node sementara = head\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA sementara tidak kosong:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  tambahkan nilai pada node sementara ke variabel total\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  pindah ke node berikutnya\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT total akhir belanjaan\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 10, 1, 'medium', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ee0d4-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Mencari Skor Peserta Tertinggi', '<p>Panitia lomba menyimpan daftar skor (80, 95, 75) ke dalam Single Linked List. Untuk mencari pemenang, panitia perlu membandingkan semua skor secara iteratif.</p><p>Telusuri seluruh SLL, tentukan nilai skor paling tinggi, dan cetak skor maksimum tersebut.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"maksimum\", \"tipe_data\": \"int\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL berisi skor: 80 -> 95 -> 75\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set maksimum = nilai head (80), lalu pindah cek ke node berikutnya\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA node belum habis:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  JIKA nilai node sekarang > maksimum MAKA maksimum = nilai node sekarang\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  pindah ke node berikutnya\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT nilai maksimum\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 11, 1, 'hard', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ee249-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Membalik Urutan Antrian Pemain', '<p>Tiga peserta masuk SLL dengan urutan 1 -> 2 -> 3. Petugas ingin membalik urutan (Reverse) sehingga yang terakhir menjadi yang pertama (3 -> 2 -> 1) hanya dengan mengubah manipulasi pointer \"next\" dari setiap Node.</p><p>Balik urutan SLL tersebut, ubah head menjadi node bernilai 3, lalu cetak urutan barunya.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"prev\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"curr\", \"tipe_data\": \"Node\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL awal: 1 -> 2 -> 3\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set Node prev = null, curr = head, next = null\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA curr tidak kosong:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  simpan alamat next (next = curr.next)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  balik arah sambungan (curr.next = prev)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  geser prev dan curr maju (prev = curr, curr = next)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Ubah head menjadi prev\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Telusuri dan PRINT hasil SLL yang dibalik\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 12, 1, 'hard', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ee45e-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menyisipkan Data di Tengah Double Linked List', '<p>Double Linked List menyimpan dua node: 10 (head) yang langsung menyambung ke 30 (tail). Buatlah program untuk menyisipkan node bernilai 20 agar berada pas di tengah-tengah antara 10 dan 30.</p><p>Sambungkan dengan benar pointer next dan prev, lalu cetak urutannya.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"DNode\"}, {\"konversi\": 0, \"variabel\": \"baru\", \"tipe_data\": \"DNode\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat DNode l1(10) dan l3(30). Sambungkan l1 <-> l3\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat node baru l2 dengan nilai 20\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Sambungkan l2.next ke l1.next (menuju 30)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Sambungkan l2.prev ke l1 (menuju 10)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Ubah prev dari 30 menjadi l2 (l1.next.prev = l2)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Ubah next dari 10 menjadi l2 (l1.next = l2)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT seluruh DLL dari head\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 13, 1, 'hard', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ee70d-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Mencabut Berkas Rusak di Tengah Urutan', '<p>SLL menyimpan ID berkas: 5 -> 10 -> 15. Berkas ber-ID <strong>10</strong> dianggap rusak dan harus dihapus. Kita harus menelusuri dari awal untuk mencari node 10, mencatat node sebelumnya, dan menyambungkan pointer melewati node yang rusak.</p><p>Lakukan logika penghapusan dengan traversal dan tracking node, lalu cetak isi SLL setelahnya.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"Node\"}, {\"konversi\": 0, \"variabel\": \"hapus\", \"tipe_data\": \"int\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat SLL: 5 -> 10 -> 15\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set node prev = null, node temp = head, ID hapus = 10\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA temp belum habis dan nilai temp != 10:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  prev = temp, temp = temp.next (maju mencari node 10)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"JIKA node ditemukan, lompati node tersebut (prev.next = temp.next)\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"PRINT sisa berkas di SLL\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 14, 1, 'hard', '2026-05-23 11:22:19', '2026-05-23 11:22:19', NULL),
('a94ee98d-5699-11f1-b849-e4a8dfe60766', '019e548c-436c-7287-a08d-3d6248338075', 'Menampilkan Riwayat Lagu Secara Mundur', '<p>Sebuah aplikasi musik menggunakan Double Linked List untuk menyimpan riwayat lagu: Rock <-> Jazz <-> Pop. Pengguna ingin melihat riwayat lagu dari yang terakhir diputar menuju yang pertama.</p><p>Gunakan pointer prev untuk menelusuri Double Linked List dari belakang ke depan, lalu cetak urutannya.</p>', '[{\"konversi\": 0, \"variabel\": \"head\", \"tipe_data\": \"DNode\"}, {\"konversi\": 0, \"variabel\": \"tail\", \"tipe_data\": \"DNode\"}]', '[{\"clue\": 0, \"langkah\": \"START\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Buat DLL: Rock <-> Jazz <-> Pop\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"Set head pada Rock dan tail pada Pop\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"LAKUKAN SELAMA tail tidak kosong:\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  PRINT data pada tail\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"  tail = tail.prev\", \"konversi\": 0}, {\"clue\": 0, \"langkah\": \"END\", \"konversi\": 0}]', 15, 1, 'hard', '2026-05-23 11:22:19', '2026-05-23 11:27:49', NULL),
('e78e4c89-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Antrian Loket Karcis Bioskop', '<p>Sebuah bioskop membuka satu loket karcis. Tiga orang datang berurutan: Rina, Doni, lalu Yudi. Setelah ketiganya mengantri, petugas ingin mengetahui siapa yang berada paling depan antrian dan berapa total orang yang sedang mengantri.</p>\r\n<p>Tentukan siapa yang berada di posisi FRONT antrian dan berapa SIZE antrian setelah ketiga orang tersebut masuk.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Deklarasikan antrian sebagai Queue kosong\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(Rina) -> antrian=[Rina]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(Doni) -> antrian=[Rina,Doni]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(Yudi) -> antrian=[Rina,Doni,Yudi]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT FRONT(antrian) -> Rina\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT SIZE(antrian) -> 3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"FIFO: Rina masuk pertama maka Rina berada di depan dan keluar pertama\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 1, 1, 'easy', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e64af-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Antrian Pasien Klinik', '<p>Sebuah klinik menerima tiga pasien secara berurutan dengan nomor antrian 101, 102, dan 103. Resepsionis ingin menampilkan nomor pasien yang berada paling depan (FRONT), paling belakang (REAR), dan total pasien yang sedang mengantri.</p>\r\n<p>Tentukan nilai FRONT, REAR, dan SIZE dari antrian tersebut.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Deklarasikan antrian kosong\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(101) -> antrian=[101], front=101, rear=101\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(102) -> antrian=[101,102], front=101, rear=102\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(103) -> antrian=[101,102,103], front=101, rear=103\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT FRONT -> 101\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT REAR  -> 103\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT SIZE  -> 3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 2, 1, 'easy', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e6ad9-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Antrian Pengambilan Obat', '<p>Apotek rumah sakit mencatat antrian pengambilan obat satu per satu. Pasien pertama bernama Siti, kemudian Bagas, lalu Citra. Setiap kali seorang pasien masuk antrian, sistem langsung mencetak isi antrian beserta jumlahnya.</p>\r\n<p>Tentukan output yang dicetak sistem setelah setiap operasi ENQUEUE.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Deklarasikan antrian kosong\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(Siti) -> antrian=[Siti]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian: [Siti] Ukuran: 1\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(Bagas) -> antrian=[Siti,Bagas]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian: [Siti,Bagas] Ukuran: 2\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(Citra) -> antrian=[Siti,Bagas,Citra]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian: [Siti,Bagas,Citra] Ukuran: 3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Setiap ENQUEUE elemen masuk dari posisi REAR (belakang)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 3, 1, 'easy', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e6f93-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Loket Bank Belum Buka', '<p>Sebelum loket bank dibuka, sistem memeriksa apakah antrian kosong menggunakan fungsi ISEMPTY. Setelah loket dibuka, dua nasabah dengan nomor 201 dan 202 mendaftar. Sistem kembali memeriksa kondisi antrian, jumlah nasabah, dan nomor nasabah terdepan.</p>\r\n<p>Tentukan seluruh output yang dihasilkan sistem secara berurutan.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Deklarasikan antrian kosong\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT ISEMPTY(antrian) -> TRUE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(201) -> antrian=[201]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(202) -> antrian=[201,202]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT ISEMPTY(antrian) -> FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT SIZE(antrian) -> 2\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT FRONT(antrian) -> 201\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ISEMPTY=TRUE jika tidak ada elemen, FALSE jika ada elemen\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 4, 1, 'easy', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e755d-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Antrian Wahana Taman Bermain', '<p>Sebuah wahana taman bermain menerima tiga pengunjung secara berurutan dengan nomor tiket 7, 8, dan 9. Petugas ingin mengetahui siapa yang paling depan, paling belakang, total pengunjung dalam antrian, dan apakah antrian sudah kosong.</p>\r\n<p>Tentukan nilai FRONT, REAR, SIZE, dan ISEMPTY dari antrian tersebut.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Deklarasikan antrian kosong\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(7) -> antrian=[7]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(8) -> antrian=[7,8]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(9) -> antrian=[7,8,9]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT FRONT  : 7\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT REAR   : 9\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT SIZE   : 3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT ISEMPTY: FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 5, 1, 'easy', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e7b61-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Memanggil Pasien Pertama di Puskesmas', '<p>Puskesmas memiliki antrian tiga pasien: Hendra (depan), Lestari, dan Miko (belakang). Dokter memanggil satu pasien dari antrian menggunakan operasi DEQUEUE. Sistem mencatat pasien yang dipanggil, sisa antrian, pasien terdepan yang baru, dan jumlah antrian setelah pemanggilan.</p>\r\n<p>Tentukan nilai variabel yang menyimpan hasil DEQUEUE, sisa isi antrian, FRONT yang baru, dan SIZE yang baru.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"dipanggil\\\",\\\"tipe_data\\\":\\\"String\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[Hendra,Lestari,Miko]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"dipanggil=DEQUEUE -> dipanggil=Hendra, antrian=[Lestari,Miko]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Dipanggil  : Hendra\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Sisa       : [Lestari,Miko]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT FRONT baru : Lestari\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT SIZE baru  : 2\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"DEQUEUE mengambil elemen dari posisi FRONT (depan)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 1, 1, 'medium', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e8163-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Melayani Seluruh Antrian Kasir Supermarket', '<p>Kasir supermarket memiliki antrian lima pembeli dengan nomor 1 hingga 5, di mana nomor 1 berada paling depan. Kasir melayani pembeli satu per satu dari depan antrian hingga antrian benar-benar kosong. Setiap kali pembeli dilayani, sistem mencetak nomor pembeli yang dilayani beserta sisa antrian.</p>\r\n<p>Tentukan seluruh output yang dicetak sistem dari awal hingga akhir secara berurutan.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"pembeli\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[1,2,3,4,5]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 1: pembeli=1, PRINT Dilayani:1 Sisa:4\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 2: pembeli=2, PRINT Dilayani:2 Sisa:3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 3: pembeli=3, PRINT Dilayani:3 Sisa:2\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 4: pembeli=4, PRINT Dilayani:4 Sisa:1\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 5: pembeli=5, PRINT Dilayani:5 Sisa:0\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian telah kosong\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 2, 1, 'medium', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e881b-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Antrian Pendaftaran Lomba Bergantian', '<p>Panitia lomba membuka pendaftaran secara bertahap. Peserta A dan B mendaftar, lalu peserta A dipanggil untuk verifikasi berkas. Kemudian peserta C mendaftar, lalu peserta B dipanggil. Terakhir peserta D mendaftar. Sistem mencatat nilai peserta yang dipanggil di setiap tahap dan menampilkan isi antrian akhir.</p>\r\n<p>Telusuri setiap langkah. Tentukan siapa peserta pertama dan kedua yang dipanggil (variabel a dan b), serta siapa saja yang masih mengantri di akhir beserta jumlahnya.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"a\\\",\\\"tipe_data\\\":\\\"String\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"b\\\",\\\"tipe_data\\\":\\\"String\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(A) -> antrian=[A]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(B) -> antrian=[A,B]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"a=DEQUEUE -> a=A, antrian=[B]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(C) -> antrian=[B,C]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"b=DEQUEUE -> b=B, antrian=[C]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE(D) -> antrian=[C,D]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT a         : A\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT b         : B\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Isi akhir : [C,D]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT SIZE      : 2\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 3, 1, 'medium', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e8f05-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Membalik Urutan Antrian Peserta Ujian', '<p>Lima peserta ujian mengantri dengan urutan nomor 1 hingga 5, di mana nomor 1 berada paling depan. Panitia ingin membalik urutan antrian agar peserta yang terakhir datang dipanggil pertama. Tekniknya: semua peserta dipindahkan ke Stack satu per satu, lalu dikembalikan ke Queue dari Stack.</p>\r\n<p>Telusuri setiap langkah pemindahan. Tentukan isi antrian sebelum dan sesudah proses pembalikan dilakukan.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"tumpukan\\\",\\\"tipe_data\\\":\\\"Stack\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[1,2,3,4,5], tumpukan=[]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Sebelum: [1,2,3,4,5]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Pindah ke Stack: DEQUEUE 1->PUSH, DEQUEUE 2->PUSH, dst\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"tumpukan=[1,2,3,4,5] top=5\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Kembalikan ke Queue: POP 5->ENQUEUE, POP 4->ENQUEUE, dst\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[5,4,3,2,1]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Sesudah: [5,4,3,2,1]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 4, 1, 'medium', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e9341-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Cek Palindrom Plat Nomor Kendaraan', '<p>Petugas parkir ingin mengecek apakah plat nomor kendaraan <strong>\"CIVIC\"</strong> merupakan palindrom (terbaca sama dari depan maupun belakang). Setiap karakter plat dimasukkan ke Queue dan Stack sekaligus, kemudian karakter hasil DEQUEUE dari Queue dibandingkan dengan hasil POP dari Stack satu per satu.</p>\r\n<p>Telusuri setiap langkah perbandingan dan tentukan apakah \"CIVIC\" merupakan palindrom.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"tumpukan\\\",\\\"tipe_data\\\":\\\"Stack\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"isPalindrom\\\",\\\"tipe_data\\\":\\\"boolean\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"kata=CIVIC\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"ENQUEUE+PUSH C,I,V,I,C\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[C,I,V,I,C], tumpukan top=C\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Bandingkan: DEQUEUE=C vs POP=C -> sama\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Bandingkan: DEQUEUE=I vs POP=I -> sama\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Bandingkan: DEQUEUE=V vs POP=V -> sama\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Bandingkan: DEQUEUE=I vs POP=I -> sama\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Bandingkan: DEQUEUE=C vs POP=C -> sama\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"isPalindrom=TRUE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Palindrom: TRUE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 5, 1, 'medium', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e96e7-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Pencarian Nomor Antrian di Rumah Sakit', '<p>Sistem antrian rumah sakit menyimpan nomor pasien <strong>[11, 22, 33, 44, 55]</strong> dalam sebuah Queue. Petugas ingin mencari apakah pasien dengan nomor <strong>33</strong> ada di antrian menggunakan sequential search. Setiap elemen yang diperiksa dipindahkan ke Queue sementara agar antrian asli dapat dipulihkan setelah pencarian selesai.</p>\r\n<p>Telusuri setiap langkah pencarian dan tentukan apakah nomor 33 ditemukan serta kondisi antrian setelah proses selesai.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"sementara\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"ditemukan\\\",\\\"tipe_data\\\":\\\"boolean\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"elemen\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[11,22,33,44,55], cari=33, ditemukan=FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 1: elemen=11, 11!=33, ENQUEUE(sementara,11)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 2: elemen=22, 22!=33, ENQUEUE(sementara,22)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 3: elemen=33, 33=33, ditemukan=TRUE, ENQUEUE(sementara,33)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 4: elemen=44, 44!=33, ENQUEUE(sementara,44)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 5: elemen=55, 55!=33, ENQUEUE(sementara,55)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Kembalikan sementara ke antrian\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Ditemukan: TRUE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian  : [11,22,33,44,55]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 1, 1, 'hard', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78e99e1-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Mencari Stok Minimum di Gudang', '<p>Sistem gudang menyimpan data stok barang dalam antrian: <strong>[50, 20, 80, 10, 60]</strong> di mana 50 adalah data terdepan. Manajer gudang ingin mencari nilai stok paling sedikit menggunakan sequential search. Setiap elemen yang diperiksa disimpan ke Queue sementara agar data antrian dapat dikembalikan setelah pencarian selesai.</p>\r\n<p>Telusuri setiap langkah perbandingan. Tentukan nilai minimum stok dan kondisi antrian setelah proses selesai.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"sementara\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"minimum\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"elemen\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[50,20,80,10,60], minimum=50\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 1: elemen=50, 50<50 FALSE, minimum=50\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 2: elemen=20, 20<50 TRUE, minimum=20\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 3: elemen=80, 80<20 FALSE, minimum=20\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 4: elemen=10, 10<20 TRUE, minimum=10\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 5: elemen=60, 60<10 FALSE, minimum=10\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Kembalikan sementara ke antrian\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Minimum: 10\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian: [50,20,80,10,60]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 2, 1, 'hard', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL);
INSERT INTO `soal` (`id`, `id_level`, `judul`, `soal`, `kunci_tipe_data`, `kunci_algoritma`, `order`, `status`, `difficulty`, `created_at`, `updated_at`, `deleted_at`) VALUES
('e78ea070-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Menghitung Frekuensi Kehadiran Siswa', '<p>Sistem absensi mencatat ID kelas siswa yang hadir dalam satu sesi: <strong>[2, 5, 2, 3, 2, 5, 4]</strong>. Wali kelas ingin menghitung berapa kali siswa dengan ID kelas <strong>2</strong> hadir menggunakan sequential search. Setiap data yang diperiksa dipindahkan ke Queue sementara agar data absensi dapat dipulihkan setelah penghitungan selesai.</p>\r\n<p>Telusuri setiap langkah dan tentukan berapa kali ID 2 muncul serta kondisi antrian setelah proses selesai.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"sementara\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"frekuensi\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"elemen\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[2,5,2,3,2,5,4], cari=2, frekuensi=0\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 1: elemen=2, 2=2 TRUE, frekuensi=1\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 2: elemen=5, 5=2 FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 3: elemen=2, 2=2 TRUE, frekuensi=2\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 4: elemen=3, 3=2 FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 5: elemen=2, 2=2 TRUE, frekuensi=3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 6: elemen=5, 5=2 FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 7: elemen=4, 4=2 FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Kembalikan sementara ke antrian\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Frekuensi 2 : 3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian     : [2,5,2,3,2,5,4]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 3, 1, 'hard', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78ea58d-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Cari Nomor Paket lalu Balik Antrian Pengiriman', '<p>Sistem logistik menyimpan antrian nomor paket: <strong>[301, 302, 303, 304, 305]</strong>. Petugas ingin mencari apakah paket <strong>303</strong> ada di antrian sambil memindahkan setiap paket ke Stack. Setelah pencarian selesai, semua paket di Stack dikembalikan ke Queue menggunakan POP dan ENQUEUE.</p>\r\n<p>Telusuri setiap langkah. Tentukan apakah paket 303 ditemukan dan tunjukkan isi antrian akhir.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"tumpukan\\\",\\\"tipe_data\\\":\\\"Stack\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"ditemukan\\\",\\\"tipe_data\\\":\\\"boolean\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"elemen\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[301,302,303,304,305], cari=303, ditemukan=FALSE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 1: DEQUEUE=301, 301!=303, PUSH(301)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 2: DEQUEUE=302, 302!=303, PUSH(302)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 3: DEQUEUE=303, 303=303, ditemukan=TRUE, PUSH(303)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 4: DEQUEUE=304, 304!=303, PUSH(304)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 5: DEQUEUE=305, 305!=303, PUSH(305)\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"tumpukan top=305\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"POP=305,304,303,302,301 -> ENQUEUE ke antrian\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[305,304,303,302,301] urutan terbalik karena Stack LIFO\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Ditemukan: TRUE\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian  : [305,304,303,302,301]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 4, 1, 'hard', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL),
('e78eaba7-543f-11f1-a937-e4a8dfe60766', '019863c4-59f9-7319-9104-08267fc3c551', 'Mencari Skor Tertinggi di Antrian Turnamen', '<p>Sistem turnamen menyimpan skor peserta dalam antrian: <strong>[75, 90, 60, 95, 80]</strong> di mana 75 adalah skor terdepan. Panitia ingin mencari skor tertinggi beserta posisinya menggunakan sequential search, sambil memindahkan setiap skor ke Stack. Setelah selesai, semua skor dikembalikan dari Stack ke Queue.</p>\r\n<p>Telusuri setiap langkah. Tentukan skor tertinggi, posisinya, dan isi antrian setelah proses selesai.</p>', '\"[{\\\"variabel\\\":\\\"antrian\\\",\\\"tipe_data\\\":\\\"Queue\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"tumpukan\\\",\\\"tipe_data\\\":\\\"Stack\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"maksimum\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"posisi\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0},{\\\"variabel\\\":\\\"index\\\",\\\"tipe_data\\\":\\\"int\\\",\\\"konversi\\\":0}]\"', '\"[{\\\"langkah\\\":\\\"START\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[75,90,60,95,80], maksimum=75, posisi=1, index=1\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 1: elemen=75, 75>75 FALSE, PUSH(75), index=2\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 2: elemen=90, 90>75 TRUE, maksimum=90, posisi=2, PUSH(90), index=3\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 3: elemen=60, 60>90 FALSE, PUSH(60), index=4\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 4: elemen=95, 95>90 TRUE, maksimum=95, posisi=4, PUSH(95), index=5\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"Iterasi 5: elemen=80, 80>95 FALSE, PUSH(80), index=6\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"POP=80,95,60,90,75 -> ENQUEUE ke antrian\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"antrian=[80,95,60,90,75]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Maksimum : 95\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Posisi   : 4\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"PRINT Antrian  : [80,95,60,90,75]\\\",\\\"clue\\\":0,\\\"konversi\\\":0},{\\\"langkah\\\":\\\"END\\\",\\\"clue\\\":0,\\\"konversi\\\":0}]\"', 5, 1, 'hard', '2026-05-20 11:34:46', '2026-05-20 11:34:46', NULL);
...
--
-- Indexes for table `ars_result`
--
ALTER TABLE `ars_result`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `ars_result_id_mahasiswa_id_level_id_soal_unique` (`id_mahasiswa`,`id_level`,`id_soal`),
  ADD KEY `ars_result_id_level_foreign` (`id_level`),
  ADD KEY `ars_result_id_soal_foreign` (`id_soal`);
...
--
-- Indexes for table `chatbot_access_logs`
--
ALTER TABLE `chatbot_access_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `chatbot_access_logs_id_mahasiswa_foreign` (`id_mahasiswa`),
  ADD KEY `chatbot_access_logs_id_level_foreign` (`id_level`),
  ADD KEY `chatbot_access_logs_id_soal_foreign` (`id_soal`);

--
-- Indexes for table `chatbot_adaptive_logs`
--
ALTER TABLE `chatbot_adaptive_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `chatbot_adaptive_logs_id_mahasiswa_foreign` (`id_mahasiswa`),
  ADD KEY `chatbot_adaptive_logs_id_kelas_foreign` (`id_kelas`),
  ADD KEY `chatbot_adaptive_logs_id_level_foreign` (`id_level`),
  ADD KEY `chatbot_adaptive_logs_id_soal_foreign` (`id_soal`),
  ADD KEY `chatbot_adaptive_logs_id_label_skor_foreign` (`id_label_skor`);
...
ALTER TABLE `chatbot_logs`
  ...
  ADD KEY `chatbot_logs_access_id_foreign` (`access_id`);
...
--
-- Constraints for table `ars_result`
--
ALTER TABLE `ars_result`
  ADD CONSTRAINT `ars_result_id_level_foreign` FOREIGN KEY (`id_level`) REFERENCES `level` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ars_result_id_mahasiswa_foreign` FOREIGN KEY (`id_mahasiswa`) REFERENCES `mahasiswa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ars_result_id_soal_foreign` FOREIGN KEY (`id_soal`) REFERENCES `soal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `chatbot_access_logs`
--
ALTER TABLE `chatbot_access_logs`
  ADD CONSTRAINT `chatbot_access_logs_id_level_foreign` FOREIGN KEY (`id_level`) REFERENCES `level` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_access_logs_id_mahasiswa_foreign` FOREIGN KEY (`id_mahasiswa`) REFERENCES `mahasiswa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_access_logs_id_soal_foreign` FOREIGN KEY (`id_soal`) REFERENCES `soal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `chatbot_adaptive_logs`
--
ALTER TABLE `chatbot_adaptive_logs`
  ADD CONSTRAINT `chatbot_adaptive_logs_id_kelas_foreign` FOREIGN KEY (`id_kelas`) REFERENCES `kelas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_adaptive_logs_id_label_skor_foreign` FOREIGN KEY (`id_label_skor`) REFERENCES `label_skor` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_adaptive_logs_id_level_foreign` FOREIGN KEY (`id_level`) REFERENCES `level` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_adaptive_logs_id_mahasiswa_foreign` FOREIGN KEY (`id_mahasiswa`) REFERENCES `mahasiswa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_adaptive_logs_id_soal_foreign` FOREIGN KEY (`id_soal`) REFERENCES `soal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `chatbot_logs`
--
ALTER TABLE `chatbot_logs`
  ADD CONSTRAINT `chatbot_logs_access_id_foreign` FOREIGN KEY (`access_id`) REFERENCES `chatbot_access_logs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_logs_id_level_foreign` FOREIGN KEY (`id_level`) REFERENCES `level` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_logs_id_mahasiswa_foreign` FOREIGN KEY (`id_mahasiswa`) REFERENCES `mahasiswa` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chatbot_logs_id_soal_foreign` FOREIGN KEY (`id_soal`) REFERENCES `soal` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
