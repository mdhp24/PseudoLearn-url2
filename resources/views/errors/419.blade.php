                ...
                <div class="d-flex flex-column flex-center text-center p-10">
                    <div class="card card-flush w-lg-650px py-5">
                        <div class="card-body py-15 py-lg-20">
                            ...
                            <div class="fw-semibold fs-6 text-gray-500 mb-7">Halaman kedaluwarsa. Silakan segarkan halaman dan coba lagi.</div>
                            <div class="mb-0">
                                <a href="{{ url('/') }}" class="btn btn-sm btn-primary">Refresh Halaman</a>
                            </div>
                        </div>
                    </div>
                </div>
