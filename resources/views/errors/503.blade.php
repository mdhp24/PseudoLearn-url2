...
<head>
    ...
    <body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
        ...
        <div class="d-flex flex-column flex-root" id="kt_app_root">
            <style>body { background-image: url('assets/media/img/bg-login2.png'); } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg7-dark.jpg'); }</style>
            <div class="d-flex flex-column flex-center flex-column-fluid">
                <div class="d-flex flex-column flex-center text-center p-10">
                    <div class="card card-flush w-lg-650px py-5">
                        <div class="card-body py-15 py-lg-20">
                            <h1 class="fw-bolder fs-2qx text-gray-900 mb-4">Under Maintenance</h1>
                            <div class="fw-semibold fs-6 text-gray-500 mb-7">Kami sedang melakukan pemeliharaan sistem.<br> Silakan coba lagi beberapa saat lagi.</div>
                            <div class="mb-0 d-flex flex-center gap-3">
                                <button type="button" onclick="location.reload()" class="btn btn-sm btn-primary">Muat Ulang</button>
                            </div>
                            <div class="mt-6 text-gray-500 fs-7">Kode Status: 503 Service Unavailable</div>
                        </div>
                    </div>
                </div>
            </div>
