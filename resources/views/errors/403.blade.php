                ...
                <div class="d-flex flex-column flex-center text-center p-10">
                    <div class="card card-flush w-lg-650px py-5">
                        <div class="card-body py-15 py-lg-20">
                            ...
                            <div class="fw-semibold fs-6 text-gray-500 mb-7">Akses ditolak. Anda tidak memiliki izin untuk mengakses halaman ini.</div>
                            <div class="mb-0">
                                <a href="{{ url('/') }}" class="btn btn-sm btn-primary">Kembali ke Beranda</a>
                            </div>
                        </div>
                    </div>
                </div>
