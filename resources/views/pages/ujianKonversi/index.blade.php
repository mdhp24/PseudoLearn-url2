...
@section('content')
<div class="container-fluid px-4" id="ujian-konversi-container">
    <div class="row">
        <div class="col-12 px-0">
            <div class="bg-white rounded-4 shadow-sm p-8">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="table-ujian-konversi">
                        <thead>
...
@push('scripts')
    <script src="{{ asset('js/ujianKonversi/index.js') }}"></script>
@endpush
