...
@section('content')
<div class="container-fluid px-4" id="scoring-container">
    <div class="row">
        <div class="col-12 px-0">
            <div class="bg-white rounded-4 shadow-sm p-8">
                <div class="mb-3">
                    <div class="p-2 fs-7 fw-normal bg-light rounded">
                        ...
                        <span class="text-warning">
                            *Pilih Kelas, Level, dan Soal terlebih dahulu untuk melihat Skor.
                        </span>
                        <br>
                        <span class="text-info">
                            *Pilih Kelas dan Level untuk melihat Rata-Rata Skor.
                        </span>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="table-scoring">
                        <thead>
...
@push('scripts')
    <script src="{{ asset('js/scoring/index.js') }}"></script>
@endpush
