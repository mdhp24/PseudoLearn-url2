    ...
    public function up(): void
    {
        ...
        DB::statement("CREATE OR REPLACE VIEW v_pseudo_konversicode AS SELECT * FROM (
            SELECT
                ...
                SUM(u.waktu) OVER (PARTITION BY u.id_mahasiswa, u.id_level, s.id) AS durasi,
            ...
            SELECT
                ...
                SUM(uk.waktu) OVER (PARTITION BY uk.id_mahasiswa, uk.id_level, bsk.id_soal) AS durasi,
